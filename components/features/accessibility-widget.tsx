  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {open && (
        <div
          ref={panelRef}
          className="absolute bottom-16 right-0 w-80 max-w-[calc(100vw-3rem)] max-h-[calc(100dvh-7rem)] overflow-y-auto rounded-xl border border-outline-variant bg-surface p-6 shadow-[var(--shadow-level-2)]"
          role="dialog"
          aria-modal="true"
